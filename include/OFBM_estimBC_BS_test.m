function [estT] = OFBM_estimBC_BS_test(est,alpha,params)
...
for p1=1:1:P-1
    for p2=p1+1:P
        ...
        %estT.pvalsortbis(p1,p2)=1-cdf('HalfNormal',abs(estT.lambdasort(p1)-estT.lambdasort(p2))/estT.SBE(p1,p2),0,1);
